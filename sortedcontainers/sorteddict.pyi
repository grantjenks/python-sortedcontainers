...
_Key = Callable[[_KT], Any]

class SortedDict(Dict[_KT, _VT], Generic[_KT, _VT]):
    @typing.overload
    ...
    @typing.overload
    def __init__(self, __key: _Key, **kwargs: _VT) -> None: ...
    @typing.overload
    def __init__(self, __key: _Key, __map: Mapping[_KT, _VT], **kwargs: _VT) -> None: ...
    @typing.overload
    def __init__(self, __key: _Key, __iterable: Iterable[Tuple[_KT, _VT]], **kwargs: _VT) -> None: ...
    @property
    ...
    def update(self, *args: Union[Mapping[_KT, _VT], Iterable[Tuple[_KT, _VT]]], **kwargs: _VT): ...
